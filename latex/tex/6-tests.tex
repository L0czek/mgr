...
\begin{figure}[h!]
    ...
    \begin{tikzpicture}
        ...
        \draw [arrow, dashed] (init) |- (secsrv) node[midway, above left] {Loads};
        \draw [arrow, dashed] (init) |- (decoder) node[midway, above left] {Loads};
    ...
    \begin{tabular}{c|c}
        \subfloat[Fuzzing from secure world.]{
            ...
            \begin{tikzpicture}
                    ...
                    \draw [arrow, dashed] (init) |- (secsrv) node[midway, above left] {Loads};
                    \draw [arrow, dashed] (init) |- (decoder) node[midway, above left] {Loads};
                    \draw [arrow, dashed] (init) |- (loop) node[midway, above left] {Loads};
            \end{tikzpicture}
                }
        } &
        \subfloat[Fuzzing from normal world.]{
            ...
            \begin{tikzpicture}
                    ...
                    \draw [darrow] (serializer) -- (interface) node[midway, right] {API};
                    \draw [darrow] (interface) -- (decoder) node[midway, right] {API};
                    \draw [arrow, dashed] (init) -- (loop) node[midway, right] {Loads};
                    \draw [arrow, dashed] (init) -| ++(-2.25cm, 0cm) node[midway, above] {Loads} |- (secsrv);
...
\begin{figure}[h!]
    ...
    \begin{tikzpicture}
        ...
        \draw [arrow, dashed] (init) |- (aflpipe) node[midway, right] {Loads};
        \draw [arrow, dashed] (init) |- (secsrv) node[midway, right] {Loads};
    \end{tikzpicture}
    }
